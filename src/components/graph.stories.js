...
WithWidget.decorators = [(Story) => (
    <div id="graph-widget" className="p-4 border dark:border-gray-800 mb-4 max-w-screen-sm">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
